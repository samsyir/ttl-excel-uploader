...
class Qhsse extends CI_Controller {
	...
	public function upload_pegawai($error = NULL) {
		...
		if($this->session->userdata('logged_in'))
    	{
	        ...
	        $this->load->view('admin/qhsse/upload_pegawai',$data);
	...
	public function do_upload_pegawai() {
        ...
        redirect(site_url('qhsse/upload_pegawai'));
	...
	public function upload_rkap($error = NULL) {
		...
		if($this->session->userdata('logged_in'))
    	{
    		$data['error'] = $error['error'];
			$this->load->view('public/themes/default/header');
	        $this->load->view('admin/qhsse/upload_rkap',$data);
	        $this->load->view('public/themes/default/footer');
	    }
	    else
	    {
    ...
    // config upload
        ...
        //redirect ke halaman awal
        redirect(site_url('qhsse/upload_rkap'));
    ...
    if($this->session->userdata('logged_in'))
      {
        $data['error'] = $error['error'];
      $this->load->view('public/themes/default/header');
          $this->load->view('admin/qhsse/upload_training',$data);
          $this->load->view('public/themes/default/footer');
      }
      else
      {
  ...
  public function do_upload_training() {
    // config upload
        ...
        //redirect ke halaman awal
        redirect(site_url('qhsse/upload_training'));
